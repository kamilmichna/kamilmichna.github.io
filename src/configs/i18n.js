    ...
    resources: {
      en: {
        translation: {
          ...
          navButtons: {first: 'My blog (WIP)', second: "Github", third: "Contact"},
          ...
          contact: {header: "Or just contact with me!",email:"Your email address",content: "Content of email",send:"Send",newsletter: "*You will not receive a newsletter, we only need your email address for return contact."}
        },
      },
      pl: {
        translation: {
          ...
          navButtons: {first: 'Mój blog  (WIP)', second: "Github", third: "Kontakt"},
          ...
          contact: {header: "Lub po prostu skontaktuj się ze mną",email:"Twój adres email",content: "Treść wiadomości",send: "Wyślij",newsletter: "*nie będziesz otrzymywał newslettera, adres email potrzebny jest jedynie do kontaktu zwrotnego"}
        },
      },
    },
  })
